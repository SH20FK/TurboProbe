                    ...
                    return (
                      ...
                      >
                        ...
                        <div className="flex items-center gap-3.5 flex-shrink-0 relative z-10">
                          {ping !== null ? (
                            <Tooltip content={`HTTPS через VPN с точки проверки: ${ping} ms; не пинг с вашего устройства`} side="left">
                            ...
                            <span className="font-mono text-xs text-[var(--text-muted)]">Не проверено</span>
                          )}
