    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 12),
          Text('Официальные супер-подписки TurboProbe (24/7 Авто-сбор):', style: GoogleFonts.roboto(fontSize: 12, fontWeight: FontWeight.w600, color: AppTheme.textSecondaryDark)),
